...
- ✅ Per-set rest max 3600s in UI + `v2_session_sets` CHECK (`ca22d9d`; apply `20260903120000` on live DB)
- ✅ Account purge deletes `avatars` storage objects before `auth.users` (`281365e`; apply `20260903130000` on live DB)
