 ...
 *
 * Apple App Store Guideline 5.1.1(i)/(ii) requires a privacy policy URL on
 * the App Store listing AND in-app for any account-creating app. Terms is
 * required for subscription / EULA differences and strongly recommended in
 * any case.
 *
