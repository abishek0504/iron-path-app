-- ============================================
-- IronPath Database Schema (Simple Version)
-- ============================================
-- This version uses standard B-tree indexes (no pg_trgm extension required)
-- If pg_trgm extension works, use supabase-schema.sql instead for better search
...
-- Indexes for fast searching (using standard B-tree indexes)
...
-- 7. Standard B-tree indexes are used (no extension required)
