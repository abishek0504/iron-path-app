...
export default function ChangeEmailScreen() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      showToast('Verify your new email', 'success');
      setInfo('Check the new email inbox to confirm the change.');
      if (__DEV__) devLog('change-email', { action: 'email-change-sent', emailRedirectTo });
    } catch (error) {
      setInfo('Unable to send email change link.');
      if (__DEV__) devError('change-email', error, { newEmail });
    } finally {
      setSending(false);
    }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>We will email a confirmation link to your new address.</Text>
        ...
        >
          {sending ? (
            ...
            <Text style={styles.buttonText}>Send confirmation link</Text>
          )}
        </TouchableOpacity>
